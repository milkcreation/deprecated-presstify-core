...
class Template extends App
{
	...
	public function __construct()
	{
		...
		\tiFy\Components\TinyMCE\TinyMCE::registerExternalPlugin( 'template', $this->Url .'/plugin.min.js', $config );	
	...
	final public function init(){
		wp_register_style( 'tify-tinymce_template', $this->Url .'/articles.css', array(), '1.150317' );
	}
