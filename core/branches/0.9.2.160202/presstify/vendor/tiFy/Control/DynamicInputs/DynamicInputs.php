<?php
namespace tiFy\Control\DynamicInputs;

use tiFy\Control\Control;

class DynamicInputs extends Control
{
	/* = ARGUMENTS = */	
	...
	{
		wp_enqueue_style( 'tify_controls-dynamic_inputs', $this->Url ."/dynamic_inputs.css", array( ), '150525' );
		wp_enqueue_script( 'tify_controls-dynamic_inputs', $this->Url ."/dynamic_inputs.js", array( 'jquery' ), '150525', true );
	}
