...
class CampaignEditForm extends EditForm
{
	...
	public function step_5( )
	{
		...
		$set_send_active = $this->master->db->queue->select()->has( 'campaign_id', $this->item->campaign_id );	
	?>
		<div class="tifybox">
			...
			<div class="inside">
				...
				<div id="totals">
					...
					<ul>
						...
						<li class="processed"><?php _e( 'Mis en file', 'tify' );?> : <span class="value"><?php echo $this->master->db->queue->select()->count( array( 'campaign_id' => $this->item->campaign_id ) );?></span></li>
					</ul>
				</div> 
			</div>	
		</div>		
