...
namespace
{
	...
	*/
	function tify_taboox_register_box( $hookname, $env, $args = array() )
	{
		...
		return $tiFy->Kernel->Taboox->registerBox( $hookname, $env, $args );
	}
	...
	*/
	function tify_taboox_register_node( $hookname, $args = array() )
	{
		...
		return $tiFy->Kernel->Taboox->registerNode( $hookname, $args );
	}
	...
	*/
	function tify_taboox_register_form( $class, $passed_args = array() )
	{
		...
		return $tiFy->Kernel->Taboox->registerAdminForm( $class, $passed_args );
	}
	
	/*
	class taboox_RegisterFormClass extends tiFy\Taboox\Form{
		// (requis) Constructeur
	...
	*/
	...
	function tify_taboox_display()
	{
		...
		return call_user_func_array( array( $tiFy->Kernel->Taboox->Screen, 'box_render' ), func_get_args() );
	}	
}
