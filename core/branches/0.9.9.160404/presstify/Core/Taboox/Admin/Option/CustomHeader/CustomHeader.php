<?php
namespace tiFy\Core\Taboox\Admin\Option\CustomHeader;
...
class CustomHeader extends Admin
{
	...
	{
		wp_enqueue_style( 'tify_taboox_custom_header', $this->Url .'/admin.css', array( 'tify-control-media_image' ), '150325' );
		wp_enqueue_script( 'tify_taboox_custom_header', $this->Url .'/admin.js', array( 'jquery', 'tify-control-media_image' ), '150325', true );
	}
