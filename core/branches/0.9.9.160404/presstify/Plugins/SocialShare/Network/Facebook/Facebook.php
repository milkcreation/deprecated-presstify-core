...
class Facebook extends App
{
	...
	{		
		...
		wp_register_script( 'tiFy_SocialShare_Facebook', $this->Url .'/Facebook.js', array( 'jquery' ), '150108', true );	
	}
	...
	final public function tify_options_register_node()
	{
		tify_options_register_node(	
			array(
				...
				'cb' 		=> "tiFy\\Plugins\\SocialShare\\Network\\Facebook\\Taboox\\Admin\\Option\\Facebook"					
			)
		);
	}
}