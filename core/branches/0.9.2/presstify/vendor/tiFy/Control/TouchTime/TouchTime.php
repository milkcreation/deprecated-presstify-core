<?php
namespace tiFy\Control\TouchTime;

use tiFy\Control\Control;

class TouchTime extends Control
{
	/* = ARGUMENTS = */	
	...
	public function enqueue_scripts()
	{
		...
		wp_enqueue_style( 'tify_controls-touch_time', $this->Url ."/touch_time.css", array( ), '150418' );
		wp_enqueue_script( 'tify_controls-touch_time', $this->Url ."/touch_time.js", array( 'jquery' ), '150418', true );
	}
