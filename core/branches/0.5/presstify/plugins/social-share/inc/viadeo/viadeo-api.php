...
/* = TABOOX = */
/** == == **/
class tiFy_SocialShare_Viadeo_Taboox extends tiFy_Taboox{
	/* = ARGUMENTS = */
	public 	// Configuration
	...
	/* = CONSTRUCTEUR = */
	function __construct( tiFy_SocialShare_Viadeo $master ){
		parent::__construct();
		$this->master = $master;
		$this->defaults['viadeo'] = $this->master->defaults;
	}
		...
		<table class="form-table">
			<tbody>			
				<tr>
					...
					<td>
						<input type="text" name="<?php echo $this->data_name;?>[viadeo][uri]" value="<?php echo $this->data_value['viadeo']['uri'];?>" size="80" placeholder="<?php _e( 'http://www.viadeo.com/profile/[identifiant du profil]', 'tify' );?>" />
					</td>
				</tr>
			</tbody>
		</table>
