...
class ScriptLoader extends App
{
	...
	private function _register_native()
	{
		self::$JsLib	= array(
			...
			'bootstrap'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/bootstrap/js/bootstrap.min.js',
			...
			'bootstrap-transitions'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/bootstrap/js/bootstrap-transitions.min.js',
					'cdn'		=> ''
				),
				'deps'		=> array( 'jquery' ),
				'version'	=> '3.3.5',
			...
			'bootstrap-modals'			=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/bootstrap/js/bootstrap-modals.min.js',
					'cdn'		=> ''
				),
			...
			'bootstrap-tooltips'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/bootstrap/js/bootstrap-tooltips.min.js',
				),
				'deps'		=> array( 'bootstrap-transitions' ),
				'version'	=> '3.3.5',
				'in_footer'	=> true 
			...
			'bootstrap-popovers'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/bootstrap/js/bootstrap-popovers.min.js',
				), 
			...
			'bootstrap-togglable-tabs'	=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/bootstrap/js/bootstrap-togglable-tabs.min.js',
				), 
				'deps'		=> array( 'bootstrap-transitions' ),
				'version'	=> '3.3.5',
				'in_footer'	=> true 
			...
			'dentist'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/dentist.min.js',
			...
			'easing'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/jquery.easing.min.js',
			...
			'holder'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/holder.min.js',
			...
			'moment'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/moment.min.js',
			...
			'mousewheel'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/jquery.mousewheel.min.js',
			...
			'nanoscroller'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/nanoscroller/jquery.nanoscroller.min.js',
			...
			'owlcarousel'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/owlcarousel/jquery.nanoscroller.min.js',
			...
			'jquery-parallax'			=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/jquery-parallax-min.js',
			...
			'spectrum'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spectrum/spectrum.min.js',
			...
			'threesixty'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/threesixty/threesixty.min.js',
				),
				'deps'		=> array( 'jquery' ),
				'version'	=> '2.0.5',
				'in_footer'	=> true 
			...
			'tify-calendar'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-calendar.js'
				),
				'deps'		=> array( 'jquery' ),
				'version'	=> '150409',
				'in_footer'	=> true 
			...
			'tify-findposts'			=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-findposts.min.js'
				),
			...
			'tify-infinite-scroll'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-infinite-scroll.js'
				),
				'deps'		=> array( 'jquery' ),
				'version'	=> '160126',
				'in_footer'	=> true
			...
			'tify-modals'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-modals.min.js'
				),
			...
			'tify-lightbox'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-lightbox.min.js'
				),
				'deps'		=> array( 'jquery' ),
				'version'	=> '150325',
				'in_footer'	=> true 
			...
			'tify-onepage-scroll'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-onepage-scroll.min.js',
					'dev'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-onepage-scroll.js'
				),
			...
			'tify-smooth-anchor'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-smooth-anchor.min.js'
				),
			...
			'tify-slideshow'			=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-slideshow.min.js'
				),
				'deps'		=> array( 'jquery', 'easing' ),
				'version'	=> '160602',
				'in_footer'	=> true 
			...
			'tify-fixed_submitdiv'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-fixed_submitdiv.min.js'
				),
				'deps'		=> array( 'jquery' ),
				'version'	=> '151023',
				'in_footer'	=> true 
			...
			'tify-video'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-video.min.js'
				),
			...
			'tify-threesixty_view'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-threesixty_view.min.js'
				),
		...
		self::$CssLib	= array(
			...
			'bootstrap'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/bootstrap/css/bootstrap.min.css',
			...
			'bootstrap-tooltips'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/bootstrap/css/bootstrap-tooltips.min.css'
				), 
				'deps'		=> array(),
				'version'	=> '3.3.5',
				'media'		=> 'all' 
			...
			'bootstrap-popovers'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/bootstrap/css/bootstrap-popovers.min.css'
				),
				'deps'		=> array( 'bootstrap-tooltips' ),
				'version'	=> '3.3.5',
				'media'		=> 'all' 
			...
			'font-awesome'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/font-awesome/css/font-awesome.min.css',
					'cdn'		=> '//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css',
					'dev'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/font-awesome/css/font-awesome.css',	// Pour les références plugin
				),
				'deps'		=> array(),
				'version'	=> '4.4.0',
				'media'		=> 'all' 
			...
			'genericons'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/genericons/genericons.css',
					'cdn'		=> '//cdn.rawgit.com/Automattic/Genericons/master/genericons/genericons.css',
					'dev'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/genericons/genericons.css',	// Pour les références plugin
				),
				'deps'		=> array(),
				'version'	=> '4.4.0',
				'media'		=> 'all' 
			...
			'nanoscroller'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/nanoscroller/nanoscroller.min.css',
			...
			'owlcarousel'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/owlcarousel/assets/owl.carousel.min.css',
			...
			'spectrum'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spectrum/spectrum.min.css',
			...
			'spinkit'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/spinkit.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-rotating-plane'	=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/1-rotating-plane.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-fading-circle'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/10-fading-circle.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-folding-cube'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/11-folding-cube.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-double-bounce'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/2-double-bounce.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-wave'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/3-wave.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-wandering-cubes'		=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/4-wandering-cubes.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-pulse'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/5-pulse.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-chasing-dots'			=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/6-chasing-dots.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-three-bounce'			=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/7-three-bounce.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-circle'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/8-circle.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'spinkit-cube-grid'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/spinkit/9-cube-grid.min.css'
				),
				'deps'		=> array(),
				'version'	=> '1.2.2',
				'media'		=> 'all' 
			...
			'threesixty'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/threesixty/threesixty.min.css'
				),
				'deps'		=> array(),
				'version'	=> '2.0.5',
				'media'		=> 'all' 
			...
			'tify-front_styles'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-front_styles.min.css'
				),
				'deps'		=> array(),
				'version'	=> '150907',
				'media'		=> 'all' 
			...
			'tify-admin_styles'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-admin_styles.min.css'
				),
				'deps'		=> array(),
				'version'	=> '150409',
				'media'		=> 'all' 
			...
			'tify-calendar'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-calendar.css'
				),
				'deps'		=> array(
					'spinkit-pulse'		
				),
			...
			'tify-slideshow'			=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-slideshow.min.css'
				),
				'deps'		=> array(),
				'version'	=> '160602',
				'media'		=> 'all'
			...
			'tify-video'					=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-video.min.css'
				),
			...
			'tify-video-theme'				=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-video-theme.css',
				),
			...
			'tify-threesixty_view'			=> array(
				'src'		=> array(
					'local'		=> $this->AbsUrl .'/Libraries/tiFy/Assets/tify/tify-threesixty_view.min.css',
				),
