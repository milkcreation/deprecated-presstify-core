...
class DropdownGlyphs extends Control
{
	/* = ARGUMENTS = */	
	...
	{
		//wp_enqueue_style( 'tify_controls-dropdown_glyphs', $this->Url ."/dropdown_glyphs.css", array( ), '141212' );
		//wp_enqueue_script( 'tify_controls-dropdown_glyphs', $this->Url ."/dropdown_glyphs.js", array( 'jquery' ), '141212', true );
	}
