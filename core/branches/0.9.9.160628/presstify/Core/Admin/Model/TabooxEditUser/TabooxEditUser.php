...
{					
	...
	{
		if( $sections = $this->View->getModelAttrs( 'sections' ) ) :			
		else :
	...
	{
		$menu_slug 		= $this->View->getModelAttrs( 'menu_slug', 'TabooxEditUser' );
		$parent_slug 	= $this->View->getModelAttrs( 'parent_slug', 'TabooxEditUser' );
