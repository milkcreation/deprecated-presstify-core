...
/* = TABOOX = */
/** == == **/
class tiFy_SocialShare_Pinterest_Taboox extends tiFy_Taboox{
	/* = ARGUMENTS = */
	public 	// Configuration
	...
	/* = CONSTRUCTEUR = */
	function __construct( tiFy_SocialShare_Pinterest $master ){
		parent::__construct();
		$this->master = $master;
		$this->defaults['pinterest'] = $this->master->defaults;
	}
		...
		<table class="form-table">
			<tbody>			
				<tr>
					...
					<td>
						<input type="text" name="<?php echo $this->data_name;?>[pinterest][uri]" value="<?php echo $this->data_value['pinterest']['uri'];?>" size="80" placeholder="<?php _e( 'https://pinterest.com/[nom du compte]', 'tify' );?>" />
					</td>
				</tr>
			</tbody>
		</table>
