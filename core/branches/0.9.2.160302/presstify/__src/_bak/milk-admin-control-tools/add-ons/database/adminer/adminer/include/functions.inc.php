...
* @return string
*/
function adminer_js_escape($string) {
...
function input($field, $value, $function) {
	...
	if ($field["type"] == "enum") {
		...
		$onchange = ($first ? " onchange=\"var f = this.form['function[" . h(adminer_js_escape(bracket_escape($field["field"]))) . "]']; if ($first > f.selectedIndex) f.selectedIndex = $first;\"" : "");
		$attrs .= $onchange;
...
var timeout = setTimeout(function () {
	ajax('<?php echo adminer_js_escape(ME); ?>script=kill', function () {
