...
class DropdownMenu extends Control
{
	...
	public function register_scripts(){
		wp_enqueue_style( 'tify_controls-'. $this->ID, $this->Url ."/dropdown_menu.css", array( ), '141212' );
		wp_enqueue_script( 'tify_controls-'. $this->ID, $this->Url ."/dropdown_menu.js", array( 'jquery' ), '141212', true );
	}
