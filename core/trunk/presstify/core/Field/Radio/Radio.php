 ...
 * @package presstiFy
 * @namespace tiFy\Core\Field\Radio
 * @version 1.1
 * @subpackage Core
 * @since 1.2.535
 *
...
class Radio extends \tiFy\Core\Field\Factory
{
    /**
     * CONTROLEURS
     */
    ...
    final protected function parseAttrs($args = [])
    {
        ...
        if (!isset($args['attrs']['id'])) :
            $args['attrs']['id'] = 'tiFyCoreField-radio--' . $this->getIndex();
        endif;
     ...
     *      @var array $attrs Liste des propriétés de la balise HTML
     *      @var string $name Attribut de configuration de la qualification de soumission du champ "name"
     *      @var null|string $value Attribut de configuration de la valeur de soumission du champ "value" si l'élément est selectionné
     *      @var null|string $checked Valeur de la selection
     * }
     *
     * @return string
