	...
	public function admin_init()
	{
		$this->Markers = array(
			'main'			=> array( 
				...
				'ico' 	=> self::getUrl( get_class($this) ) .'/images/markers/marker.png',
				'max'	=> 1
			),
			'entertainment' =>  array( 
				'label' => __( 'Loisirs', 'tify' ),
				'ico' 	=> self::getUrl( get_class($this) ) .'/images/markers/entertainment.png',
				'max'	=> 0
			),
			'school' 		=>  array( 
				'label' => __( 'Écoles', 'tify' ),
				'ico' 	=> self::getUrl( get_class($this) ) .'/images/markers/school.png',
				'max'	=> 0
			),
			'shop' 			=>  array( 
				'label' => __( 'Commerces', 'tify' ),
				'ico' 	=> self::getUrl( get_class($this) ) .'/images/markers/shop.png',
				'max'	=> 0
			),
			'mayor' 		=>  array( 
				'label' => __( 'Mairies', 'tify' ),
				'ico' 	=> self::getUrl( get_class($this) ) .'/images/markers/mayor.png',
				'max'	=> 0
			),
			'transport' 	=>  array( 
				'label' => __( 'Transports', 'tify' ),
				'ico' 	=> self::getUrl( get_class($this) ) .'/images/markers/transport.png',
				'max'	=> 0
			),
			'service'		=>  array( 
				'label' => __( 'Services', 'tify' ),
				'ico' 	=> self::getUrl( get_class($this) ) .'/images/markers/service.png',
				'max'	=> 0
			)				
		);
		...
		wp_register_style( 'tiFyCoreTabooxAdminPostGoogleMapAdminGoogleMap', self::getUrl() .'/GoogleMap.css', array( ), 161207 );			
