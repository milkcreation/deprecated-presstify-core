<?php
namespace tiFy\Core\Ui\Admin\Templates\UserList;

class UserList extends \tiFy\Core\Ui\Admin\Templates\Table\Table
{
    // Paramètres
    use Traits\Params;
    ...
    public function admin_enqueue_scripts()
    {
        ...
        \wp_enqueue_style('tiFyCoreUiAdminTemplatesUserList', self::tFyAppAssetsUrl('UserList.css', get_class()), [], 171115);
    }
