...
class MailOptions extends \tiFy\Core\Taboox\Option\Admin
{
    ...
    ?>
        <?php if( in_array( 'hookpage', $this->args['admin'] ) ) :?>
        ...
        <?php if( in_array( 'confirmation', $this->args['admin'] ) ) :?>
        ...
        <?php if( in_array( 'notification', $this->args['admin'] ) ) :?>
            ...
            <tbody>
                <tr>
                    ...
                    <?php 
                        tify_control_switch( 
                            array( 
                                'name'      => $this->args['id'] .'-notification', 
                                'checked'   => ( $checked = get_option( $this->args['id'] .'-notification' ) ) ? $checked : 'off'
                            ) 
                        );
                    ?>
                </td>
