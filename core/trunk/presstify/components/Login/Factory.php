...
class Factory
{
	...
	private function _loginFormParseArgs( $args = array() )
	{
		$defaults = array(
	...
	private function _setErrorsMap()
	{
		$defaults = array(
