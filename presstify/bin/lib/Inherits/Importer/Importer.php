...
{    
     ...
     */
    public $InputDatas          = array();
    
    /**
     * Liste des données définies 
     * @var array
     */
    protected $SettedDatas      = array();
    
    /**
     * Liste des données filtrées  
     * @var array
     */
    protected $FilteredDatas    = array();
     ...
     * @var array
     */
    private $TaxDatas        = array();
    
    /**
     * Liste des données d'option à insérer  
     * @var array
     */
    private $OptDatas        = array();
     ...
     */
    final public function _parseAttrs( $attrs = array() )
    {
     ...
     * Traitement des définitions de données
     */
    final public function _parseSettedDatas( $inputdata = array() )
    {
    ...
    {
        return new \WP_Error( 'tiFyInheritsImport_NoDataInsertCb', __( 'Méthode d\'enregistrement des données d\'import non définie', 'tify' ) );
    }
    ...
    {
        return new \WP_Error( 'tiFyInheritsImport_NoMetaDataInsertCb', __( 'Méthode d\'enregistrement des metadonnées d\'import non définie', 'tify' ) );       
    }
    ...
    {
        return new \WP_Error( 'tiFyInheritsImport_NoTaxonomyTermsInsertCb', __( 'Méthode d\'enregistrement des termes de taxonomie d\'import non définie', 'tify' ) );       
    }
    ...
    {
        return new \WP_Error( 'tiFyInheritsImport_NoOptionInsertCb', __( 'Méthode d\'enregistrement des options d\'import non définie', 'tify' ) );       
    }
