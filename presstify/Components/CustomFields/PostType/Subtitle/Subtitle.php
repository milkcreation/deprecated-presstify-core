...
class Subtitle
{
	...
	{
	?>
		<input type="text" class="widefat"  name="tify_meta_post[_subtitle]" value="<?php echo wp_unslash( get_post_meta( $post->ID, '_subtitle', true ) );?>" placeholder="<?php _e( 'Sous-titre', 'tify' );?>"
