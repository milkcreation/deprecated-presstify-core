...
class ConfigConvertor extends App
{
	...
	{
		$this->Hookname = add_menu_page( 'DevToolsConfigConvertor', __( 'Converteur de configuration', 'tify' ), 'manage_options', 'tiFyDevToolsConfigConvertor', array( $this, 'adminRender' ) );
	}
