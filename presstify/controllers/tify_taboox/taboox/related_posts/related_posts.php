<?php
/* = Déclaration = */
add_action( 'tify_taboox_register_form', 'tify_taboox_related_posts_init' );
function tify_taboox_related_posts_init(){
	tify_taboox_register_form( 'tiFy_Taboox_RelatedPosts' );
}

/* = Formulaire de saisie = */
class tiFy_Taboox_RelatedPosts extends tiFy_Taboox{
	public	$data_name 	= 'tify_post_meta[single][tify_taboox_related_post]',
