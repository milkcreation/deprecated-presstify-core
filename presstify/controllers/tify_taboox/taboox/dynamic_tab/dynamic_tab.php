...
add_action( 'tify_taboox_register_form', 'tify_taboox_dynamic_tab_init' );
function tify_taboox_dynamic_tab_init(){
	tify_taboox_register_form( 'tiFy_Taboox_DynamicTab' );
}

/* = Taboox = */
class tiFy_Taboox_DynamicTab extends tiFy_Taboox{
	/* = ARGUMENTS = */
	...
	public function wp_admin_enqueue_scripts(){
		wp_enqueue_script( 'tify_taboox_dynamic_tab', $this->uri .'/admin.js', array( 'jquery' ), '150325', true );
	}
