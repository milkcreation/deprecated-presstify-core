...
add_action( 'tify_taboox_register_form', 'tify_taboox_register_form_simple_google_map' );
function tify_taboox_register_form_simple_google_map(){
	tify_taboox_register_form( 'tiFy_Taboox_SimpleGoogleMap' );
}

class tiFy_Taboox_SimpleGoogleMap extends tiFy_Taboox{
