...
class Params extends App
{
	...
	{
		$dir = ( defined( 'TIFY_CONFIG_DIR' ) ) ? TIFY_CONFIG_DIR : get_template_directory() .'/config';
		$ext = ( defined( 'TIFY_CONFIG_EXT' ) && in_array( TIFY_CONFIG_EXT, array( 'json', 'yml' ) ) ) ? TIFY_CONFIG_EXT : 'yml';
		$attrs = array(
			'config'		=> array(
				'eval'			=> true		
			),
