...
class DynamicInputs extends Factory
{
	...
	{
		wp_register_style( 'tify_control-dynamic_inputs', $this->Url ."/dynamic_inputs.css", array( ), '150525' );
		wp_register_script( 'tify_control-dynamic_inputs', $this->Url ."/dynamic_inputs.js", array( 'jquery' ), '150525', true );
	}
	...
	public static function display( $args = array() )
	{
		...
		$output .= "\t\t<a href=\"#tify_control_dynamic_inputs-add_button\" data-name=\"{$args['name']}\" data-default=\"{$args['default']}\" class=\"tify_control_dynamic_inputs-add_button button-secondary\">\n";
