...
class Factory
{
	...
	private function Parse( $labels = array() )
	{
		...
		$defaults = array(
			...
			'view_item'          			=> ! $this->Gender ? __( sprintf( 'Voir cet %s', $this->Singular ), 'tify' ) : __( sprintf( 'Voir cette %s', $this->Singular ), 'tify' ),
			...
			'update_item'					=> ! $this->Gender ? __( sprintf( 'Mettre à jour cet %s', $this->Singular ), 'tify' ) : __( sprintf( 'Mettre à jour cette %s', $this->Singular ), 'tify' ),
			...
			'datas_item'					=> ! $this->Gender ? __( sprintf( 'Données de cet %s', $this->Singular ), 'tify' ) : __( sprintf( 'Données de cette %s', $this->Singular ), 'tify' ),
