...
abstract class Table extends \WP_List_Table
{
	...
	protected $ParamsMap			= array( 
		'BaseUri', 'EditBaseUri', 'Plural', 'Singular', 'Notices', 'Statuses', 'FilteredViewLinks', 'Columns', 'SortableColumns', 'PerPage',  
	...
	{
		$this->BaseUri = $this->View->getModelAttrs( 'base_url' );
	}
	...
	{	
		...
		elseif( $columns = $this->View->getModelAttrs( 'columns' ) ) :
		else :
