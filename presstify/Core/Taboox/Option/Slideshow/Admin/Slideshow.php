...
class Slideshow extends Admin
{
	...
	public function admin_enqueue_scripts()
	{
		...
		wp_register_script( 'jQuery-tinyMCE', '//cdn.tinymce.com/4/jquery.tinymce.min.js', array( 'jquery' ), true );
		
		wp_enqueue_media();
		wp_enqueue_style( 'tify_taboox_slideshow', $this->Url .'/admin.css', array( 'tify_control-switch', 'tify_control-suggest', 'tify_control-touch_time' ), '160222' );
		wp_enqueue_script( 'tify_taboox_slideshow', $this->Url .'/admin.js', array( 'jQuery-tinyMCE', 'tify_control-suggest', 'tify_control-touch_time', 'jquery-ui-sortable' ), '160222', true );
		wp_localize_script( 
