...
class tiFy_CoreScriptLoader{
	...
	private function _register_native(){
		$this->js	= array(
			...
			// Easing
			'holder'					=> array(
				'local'		=> $this->master->uri. 'assets/holder.min.js',
			...
			// MouseWheel
			'mousewheel'				=> array(
				'local'		=> $this->master->uri. 'assets/jquery.mousewheel.min.js',
			...
			// OwlCarousel				
			'owlcarousel'				=> array(
				'local'		=> $this->master->uri. 'assets/owlcarousel/jquery.nanoscroller.min.js',
			...
			'tify-infinite-scroll'		=> array(
					'local'		=> $this->master->uri .'assets/tify/tify-infinite-scroll.js',
					'deps'		=> array( 'jquery' ),
					'version'	=> '160126',
					'in_footer'	=> true
			),
			...
			'tify-onepage-scroll'		=> array(
				'local'		=> $this->master->uri .'assets/tify/tify-onepage-scroll.min.js',
				'dev'		=> $this->master->uri .'assets/tify/tify-onepage-scroll.js',
		...
		$this->css	= array(
			...
			// NanoScroller
			'owlcarousel'					=> array(
				'local'		=> $this->master->uri. 'assets/owlcarousel/assets/owl.carousel.min.css',
			...
			'tify-video-theme'				=> array(
				'local'		=> $this->master->uri. 'assets/tify/tify-video-theme.css',
				'cdn'		=> '',
