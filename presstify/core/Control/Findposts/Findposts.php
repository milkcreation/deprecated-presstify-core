...
class Findposts extends \tiFy\Core\Control\Factory
{
    ...
    {
        wp_register_style( 'tify_control-findposts', self::getUrl( get_class() ) ."/findposts.css", array(), '170530' );
        wp_register_script( 'tify_control-findposts', self::getUrl( get_class() ) ."/findposts.js", array( 'media' ), '170530' );
