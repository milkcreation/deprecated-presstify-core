<?php
namespace tiFy\Core\Taboox\Admin\Post\GoogleMap;

use tiFy\Core\Taboox\Admin;

class GoogleMap extends Admin
{
	...
	function admin_enqueue_scripts( ){
		...
		$this->main_marker = apply_filters( 
			...
			array( 
				...
				'ico' 	=> $this->Url .'/images/markers/marker.png'
			) 
		);
		...
		$this->marker_types = apply_filters( 
			...
			array(			
				'entertainment' =>  array( 
					...
					'ico' 	=> $this->Url .'/images/markers/entertainment.png',
					'max'	=> 0
				),
				'school' =>  array( 
					'label' => __( '&Eacute;coles', 'tify' ),
					'ico' 	=> $this->Url .'/images/markers/school.png',
					'max'	=> 0
				),
				'shop' =>  array( 
					'label' => __( 'Commerces', 'tify' ),
					'ico' 	=> $this->Url .'/images/markers/shop.png',
					'max'	=> 0
				),
				'mayor' =>  array( 
					'label' => __( 'Mairies', 'tify' ),
					'ico' 	=> $this->Url .'/images/markers/mayor.png',
					'max'	=> 0
				),
				'transport' =>  array( 
					'label' => __( 'Transports', 'tify' ),
					'ico' 	=> $this->Url .'/images/markers/transport.png',
					'max'	=> 0
				),
				'service' =>  array( 
					'label' => __( 'Services', 'tify' ),
					'ico' 	=> $this->Url .'/images/markers/service.png',
					'max'	=> 0
				)
			)
		);
		...
		wp_register_style( 'taboox-google_map',$this->Url .'/admin.css', array( ), '150324' );
		...
		wp_register_script( 'taboox-google_map', $this->Url .'/admin.js', array( 'jquery', 'google-map', 'gmap3' ), '150324', true );
