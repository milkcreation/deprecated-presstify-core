 ...
 * @package presstiFy
 * @namespace tiFy\Core\Field\DatetimeJs
 * @version 1.1
 * @subpackage Core
 * @since 1.2.535
 *
...
class DatetimeJs extends \tiFy\Core\Field\Factory
{
    /**
     * DECLENCHEURS
     */
    ...
    {
        \wp_register_style('tiFyCoreFieldDatetimeJs', self::tFyAppAssetsUrl('DatetimeJs.css', get_class()), [], 171112);
        \wp_register_script('tiFyCoreFieldDatetimeJs', self::tFyAppAssetsUrl('DatetimeJs.js', get_class()), ['jquery', 'moment'], 171112, true);
    }
    ...
    {
        \wp_enqueue_style('tiFyCoreFieldDatetimeJs');
        \wp_enqueue_script('tiFyCoreFieldDatetimeJs');
    }
     ...
     *          @see \tiFy\Core\Field\Number\Number|\tiFy\Core\Field\Select\Select
     *      }
     * }
     *
     * @return array
    ...
    final protected function parseAttrs($args = [])
    {
        ...
        $defaults = [
            'before'          => '',
            'after'           => '',
            'container_id'    => 'tiFyCoreField-datetimeJs--' . $this->getIndex(),
            'container_class' => '',
            'name'            => '',
            'value'           => '',
            'format'          => 'datetime',
        ...
        if (!isset($args['container_class'])) :
            $args['container_class'] = 'tiFyCoreField-datetimeJs ' . $args['container_class'];
        else :
            $args['container_class'] = 'tiFyCoreField-datetimeJs';
        endif;
                ...
                case 'year' :
                    $defaults = [
                        'attrs'      => [
                            ...
                            'class'         => 'tiFyCoreField-datetimeJsField tiFyCoreField-datetimeJsField--year',
                            'size'         => 4,
                            'maxlength'    => 4,
                            'min'          => 0,
                            'autocomplete' => 'off'
                ...
                case 'month' :
                    ...
                    $defaults = [
                        'attrs'      => [
                            ...
                            'class' => 'tiFyCoreField-datetimeJsField tiFyCoreField-datetimeJsField--month',
                            'autocomplete' => 'off'
                        ],
                        'selected'        => $m,
                ...
                case 'day' :
                    $defaults = [
                        'attrs'      => [
                            ...
                            'class'        => 'tiFyCoreField-datetimeJsField tiFyCoreField-datetimeJsField--day',
                            'size'         => 2,
                            'maxlength'    => 2,
                            'min'          => $this->getAttr('none_allowed') ? 0 : 1,
                            'max'          => 31,
                            'autocomplete' => 'off',
                        ],
                        'value'           => zeroise($d, 2)
                ...
                case 'hour' :
                    $defaults = [
                        'attrs'      => [
                            ...
                            'class'        => 'tiFyCoreField-datetimeJsField tiFyCoreField-datetimeJsField--hour',
                            'size'         => 2,
                            'maxlength'    => 2,
                            'min'          => 0,
                            'max'          => 23,
                ...
                case 'minute' :
                    $defaults = [
                        'attrs'      => [
                            ...
                            'class'        => 'tiFyCoreField-datetimeJsField tiFyCoreField-datetimeJsField--minute',
                            'size'         => 2,
                            'maxlength'    => 2,
                            'min'          => 0,
                            'max'          => 59,
                ...
                case 'second' :
                    $defaults = [
                        'attrs'      => [
                            ...
                            'class'        => 'tiFyCoreField-datetimeJsField tiFyCoreField-datetimeJsField--second',
                            'size'         => 2,
                            'maxlength'    => 2,
                            'min'          => 0,
                            'max'          => 59,
    ...
    >
        ...
        <?php
            Field::Hidden(
                [
                    'attrs' => [
                        'id'           => 'tiFyCoreField-datetimeJsInput--' . $this->getIndex(),
                        'class'        => 'tiFyCoreField-datetimeJsField tiFyCoreField-datetimeJsField--value',
                        'name'         => $this->getName(),
                        'value'        => $value
                    ]
                ],
