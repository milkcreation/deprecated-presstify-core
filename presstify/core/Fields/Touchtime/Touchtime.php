...
class Touchtime extends \tiFy\Core\Fields\Factory
{
	...
	public static function display($attrs = [])
    {
		...
		$defaults = [
            'id'				=> 'tiFyCoreFields-Touchtime-' . self::$Instance,
        ...
        $output .= Fields::Hidden(
            [
                ...
                'container_id'      => 'tiFyCoreFields-touchtimeInput--'  . self::$Instance,
                'container_class'   => 'tiFyCoreFields-touchtimeField tiFyCoreFields-touchtimeField--value',
                'name'              => $name,
                'value'             => $value,
                'html_attrs'        => [
                    'autocomplete'      => 'off',
