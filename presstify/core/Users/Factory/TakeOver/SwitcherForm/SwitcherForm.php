 ...
 * @package presstiFy
 * @subpackage Core
 * @namespace tiFy\Core\Users\TakeOver\SwitcherForm\SwitcherForm
 * @version 1.1
 * @since 1.2.535
 *
...
namespace tiFy\Core\Users\Factory\TakeOver\SwitcherForm;

use tiFy\Core\Users\Users;
use tiFy\Core\Fields\Fields;

use tiFy\Lib\Users\Users as UsersLib;
...
class SwitcherForm extends \tiFy\Core\Control\Factory
{
    ...
    {
        Fields::enqueue_scripts('AjaxSelect');
    ...
    public function wp_ajax_get_users()
    {
        ...
        $user_options = UsersLib::userQueryKeyValue(
            'ID',
            'display_name',
            [
    ...
    protected static function display($attrs = [], $echo = true)
    {
        ...
        if (!$takeOver = Users::getTakeOver($take_over_id)) :
            return;
        ...
        foreach($allowed_roles as $allowed_role) :
            ...
            $role_options[$allowed_role] = UsersLib::roleDisplayName($allowed_role);
        endforeach;
