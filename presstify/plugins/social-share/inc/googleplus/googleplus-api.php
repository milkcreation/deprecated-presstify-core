		...
		<table class="form-table">
			<tbody>			
				<tr>
					...
					<td>
						<input type="text" name="<?php echo $this->data_name;?>[gplus][uri]" value="<?php echo $this->data_value['gplus']['uri'];?>" size="80" placeholder="<?php _e( 'https://plus.google.com/[nom de la page]', 'tify' );?>" />
					</td>
				</tr>
			</tbody>
		</table>
