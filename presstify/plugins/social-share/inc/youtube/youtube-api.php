		...
		<table class="form-table">
			<tbody>			
				<tr>
					...
					<td>
						<input type="text" name="<?php echo $this->data_name;?>[youtube][uri]" value="<?php echo $this->data_value['youtube']['uri'];?>" size="80" placeholder="<?php _e( 'https://www.youtube.com/channel/[nom de la chaîne]', 'tify' );?>" />
					</td>
				</tr>
			</tbody>
		</table>
