...
class tiFy_SocialShare_Facebook{
	...
	function wp_init(){
		...
		if( ! empty( $this->options['appId'] ) )
			tify_facebook_sdk_init( $this->options['appId'] );
...
/* = TABOOX = */
/** == == **/
class tiFy_SocialShare_Facebook_Taboox extends tiFy\Taboox\Admin
{
	/* = ARGUMENTS = */
	private	$master;
	
	/* = CONSTRUCTEUR = */
	public function __construct( tiFy_SocialShare_Facebook $master )
	{
		parent::__construct();	
		$this->master = $master;		
	}
