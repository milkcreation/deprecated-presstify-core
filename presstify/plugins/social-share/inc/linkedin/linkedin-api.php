		...
		<table class="form-table">
			<tbody>			
				<tr>
					...
					<td>
						<input type="text" name="<?php echo $this->data_name;?>[linkedin][uri]" value="<?php echo $this->data_value['linkedin']['uri'];?>" size="80" placeholder="<?php _e( 'https://www.linkedin.com/profile/[nom du compte]', 'tify' );?>" />
					</td>
				</tr>
			</tbody>
		</table>
