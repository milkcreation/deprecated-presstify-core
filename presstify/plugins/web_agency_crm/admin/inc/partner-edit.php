...
class WACRM_AdministrativeDetails_Taboox extends tiFy\Taboox\Admin
{
		/* = CONSTRUCTEUR = */
...
class WACRM_Location_Taboox extends tiFy\Taboox\Admin
{
		/* = CONSTRUCTEUR = */
	public function __construct( tiFy_WebAgencyCRM_AdminEditPartner $master ){
		$this->master = $master;
...
class WACRM_Contact_Taboox extends tiFy\Taboox\Admin
{
	/* = CONSTRUCTEUR = */
	public function __construct( tiFy_WebAgencyCRM_AdminEditPartner $master ){
		$this->master = $master;
