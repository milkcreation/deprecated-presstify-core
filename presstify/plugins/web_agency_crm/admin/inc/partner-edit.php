...
class WACRM_AdministrativeDetails_Taboox extends tiFy_Taboox{
		/* = CONSTRUCTEUR = */
...
class WACRM_Location_Taboox extends tiFy_Taboox{
		/* = CONSTRUCTEUR = */
	public function __construct( tiFy_WebAgencyCRM_AdminEditPartner $master ){
		$this->master = $master;
		parent::__construct();
...
class WACRM_Contact_Taboox extends tiFy_Taboox{
	/* = CONSTRUCTEUR = */
	public function __construct( tiFy_WebAgencyCRM_AdminEditPartner $master ){
		$this->master = $master;
		parent::__construct();
