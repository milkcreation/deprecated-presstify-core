...
class tiFy_SEO{
	...
	public function __construct(){
		...
		require_once( $this->dir .'/Taboox/GoogleAnalytics.php' );	
		require_once( $this->dir .'/Taboox/MetaTag.php' );
		require_once( $this->dir .'/Taboox/OpenGraph.php' );
		...
		add_filter( 'tify_seo_title_post_type_archive', array( $this, '_title_for_hook_for_archive' ), 10, 3 );
		...
		add_filter( 'tify_seo_desc_post_type_archive', array( $this, '_desc_for_post_type_archive' ), 10, 3 );
	}
	...
	/** == HOOK FOR ARCHIVE == **/
	function _title_for_hook_for_archive( $title ) {
		global $post;
	...
	/** == HOOK FOR ARCHIVE == **/
	function _desc_for_post_type_archive( $desc ) {
		global $post;
