...
/** == FORUM == **/
/*** === Options des forum === ***/
class tiFy_Forum_Options_TabooxForum extends tiFy\Taboox\Admin{
	/* = ARGUMENTS = */
...
class tiFy_Forum_Options_TabooxTopic extends tiFy\Taboox\Admin{
	/* = ARGUMENTS = */
	public 	$name = '';
...
class tiFy_Forum_Options_TabooxContributor extends tiFy\Taboox\Admin{
	/* = ARGUMENTS = */
	public 	// Configuration
...
class tiFy_Forum_Options_TabooxContributionGlobal extends tiFy\Taboox\Admin{
	/* = ARGUMENTS = */
	public 	// Configuration
...
class tiFy_Forum_Options_TabooxContributionMailing extends tiFy\Taboox\Admin{
	/* = ARGUMENTS = */
	public 	// Configuration
...
class tiFy_Forum_Options_TabooxContributionModeration extends tiFy\Taboox\Admin
{
	/* = ARGUMENTS = */
	public 	// Configuration
