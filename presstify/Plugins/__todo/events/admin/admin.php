...
class tiFy_Events_Taboox extends tiFy\Core\Taboox\Admin
{
	/* = ARGUMENTS = */
	public	// contrôleur
			$master;
	...
	final public function wp_post_edit_form_tag( $post )
	{
		// Bypass
	...
	final public function wp_save_post( $post_id, $post )
	{
	...
	/** == Traitement des données == **/
	private function parse_datas( $datas ){
