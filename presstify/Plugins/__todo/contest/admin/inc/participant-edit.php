<?php
class tiFy_Contest_Participant_AdminEditForm extends tiFy_AdminView_Edit_Form{
	/* = ARGUMENTS = */
	...
	function get_errors(){
		/*if( $this->master->tify_forms->errors->has() )
			return $this->master->tify_forms->errors->display();
