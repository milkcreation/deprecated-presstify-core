...
/** == FORUM == **/
/*** === Options des forum === ***/
class tiFy_Forum_Options_TabooxForum extends tiFy\Core\Taboox\Admin{
	/* = ARGUMENTS = */
...
class tiFy_Forum_Options_TabooxTopic extends tiFy\Core\Taboox\Admin{
	/* = ARGUMENTS = */
	public 	$name = '';
...
class tiFy_Forum_Options_TabooxContributor extends tiFy\Core\Taboox\Admin{
	/* = ARGUMENTS = */
	public 	// Configuration
...
class tiFy_Forum_Options_TabooxContributionGlobal extends tiFy\Core\Taboox\Admin{
	/* = ARGUMENTS = */
	public 	// Configuration
...
class tiFy_Forum_Options_TabooxContributionMailing extends tiFy\Core\Taboox\Admin{
	/* = ARGUMENTS = */
	public 	// Configuration
...
class tiFy_Forum_Options_TabooxContributionModeration extends tiFy\Core\Taboox\Admin
{
	/* = ARGUMENTS = */
	public 	// Configuration
