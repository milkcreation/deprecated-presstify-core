...
function tify_fb_api_share_button( $args = array() ){
	...
	$appId = isset( \tiFy\Plugins\SocialShare\SocialShare::$Options['fb'] ) ? \tiFy\Plugins\SocialShare\SocialShare::$Options['fb']['appId']: ''; 	
	$fb = new tiFy\Lib\Facebook\Facebook( $appId );	
	$fb->JSInit();
