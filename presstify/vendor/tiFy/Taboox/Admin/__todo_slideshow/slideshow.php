...
class tiFy_editbox_slideshow{
	...
	function admin_init(){
		...
		wp_register_style( 'home-slideshow-options', $this->Url ."/css/home_slideshow-options.css", array(), '130608' );
		wp_register_script( 'home-slideshow-options',$this->Url ."/js/home_slideshow-options.js", array( 'jQuery-tinyMCE', 'jquery-ui-autocomplete', 'jquery-ui-sortable', 'tinyMCE' ), '130608', true );	
