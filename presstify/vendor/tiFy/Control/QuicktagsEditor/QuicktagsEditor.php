...
class QuicktagsEditor extends Control
{
	/* = ARGUMENTS = */	
	...
	{
		wp_enqueue_style( 'tify_controls-quicktags_editor', $this->Url ."/quicktags_editor.css", array( 'font-awesome' ), '141212' );
		wp_enqueue_script( 'tify_controls-quicktags_editor', $this->Url ."/quicktags_editor.js", array( 'jquery', 'quicktags' ), '141212', true );
