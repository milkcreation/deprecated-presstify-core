...
class Checkbox extends Control
{
	...
	{
		wp_enqueue_style( 'tify_controls-checkbox', $this->Url ."/checkbox.css", array( 'dashicons' ), '150420' );
		wp_enqueue_script( 'tify_controls-checkbox', $this->Url ."/checkbox.js", array( 'jquery' ), '150420', true );
	}
