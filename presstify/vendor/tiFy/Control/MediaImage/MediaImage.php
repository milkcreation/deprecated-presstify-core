...
class MediaImage extends Control
{
	/* = ARGUMENTS = */	
	...
	{	
		wp_enqueue_media();	
		wp_enqueue_style( 'tify_controls-media_image', $this->Url ."/media_image.css", array( ), '141212' );
		wp_enqueue_script( 'tify_controls-media_image', $this->Url ."/media_image.js", array( 'jquery' ), '141212', true );
	}
