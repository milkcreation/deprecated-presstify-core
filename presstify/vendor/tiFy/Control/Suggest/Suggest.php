...
class Suggest extends Control
{
	...
	protected $CallActions				= array( 'wp_ajax_tify_control_suggest_ajax', 'wp_ajax_nopriv_tify_control_suggest_ajax' );
	
	// Fonctions de rappel des actions
	protected $CallActionsFunctionsMap	= array( 'wp_ajax_tify_control_suggest_ajax' => 'wp_ajax', 'wp_ajax_nopriv_tify_control_suggest_ajax' => 'wp_ajax' );
		
	/* = MISE EN FILE DES SCRIPTS = */
	public function enqueue_scripts()
	{
		wp_enqueue_style( 'tify_controls-'. $this->ID, $this->Url .'/suggest.css', array( ), '160222' );
		wp_enqueue_script( 'tify_controls-'. $this->ID, $this->Url .'/suggest.js', array( 'jquery-ui-autocomplete' ), '160222', true );
	}
