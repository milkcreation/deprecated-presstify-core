...
namespace
{
	...
	function tify_hookarchive_get_post_type_hooks( $post_type, $permalink = true )
	{
		return tiFy\Components\HookArchive\HookArchive::GetPostTypeHooks( $post_type, $permalink );
	}
