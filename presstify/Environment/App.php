...
abstract class App
{
	use Traits\Actions, Traits\Env, Traits\Filters, Traits\Getter, Traits\Helpers, Traits\Path, Traits\Setter
	{
		Traits\Actions::__construct as private __ActionsConstruct;
		Traits\Actions::__call as private __ActionsCall;
		Traits\Env::__get as private __EnvGet;
		Traits\Env::__set as private __EnvSet;
